...
class AdminsAdapter(private val mContext: Activity, private val itemsList: ArrayList<Admins>?) :
    RecyclerView.Adapter<AdminsAdapter.SingleItemRowHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val v =
            LayoutInflater.from(viewGroup.context).inflate(R.layout.item_admin, null)
    ...
    override fun onBindViewHolder(
        ...
        holder.password.text = singleItem.password
        holder.name.text = singleItem.name
        holder.phone.text = singleItem.phone
        ...
        holder.update.setOnClickListener {
            ...
            mContext.startActivity(
                Intent(mContext, UpdateAdminActivity::class.java)
            )
