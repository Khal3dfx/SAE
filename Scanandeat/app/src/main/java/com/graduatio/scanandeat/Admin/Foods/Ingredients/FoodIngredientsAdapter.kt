...
class FoodIngredientsAdapter(private val mContext: Activity, private val itemsList: ArrayList<Ingredients>?) :
    RecyclerView.Adapter<FoodIngredientsAdapter.SingleItemRowHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val v =
            LayoutInflater.from(viewGroup.context).inflate(R.layout.item_ingredients_food, null)
    ...
    private fun Delete(id: String?, i: Int) {
        ...
        mDatabase!!.child("Foods").child(food?.id.toString()).child("Ingredient").child(id!!).removeValue()
